...
export default function EventDetailModal({ event, open, onOpenChange }: EventDetailModalProps) {
  ...
  const completeRegistration = () => {
    ...
    toast({
      ...
      description: `You have registered for ${event.title}. A confirmation email has been sent to ${registrationForm.email}.`,
      variant: "success",
    })
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              <h3 className="text-base sm:text-lg font-semibold">Date & Time</h3>
              ...
              {!isRegistering ? (
                ...
                <div className="border rounded-lg p-3 sm:p-4 space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="text-base sm:text-lg font-semibold">Registration Form</h3>
                  ...
                  <form onSubmit={handleRegister} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="phone" name="phone" value={registrationForm.phone} onChange={handleInputChange} />
                    </div>
        ...
        <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
          <AlertDialogContent className="w-[calc(100%-2rem)] max-w-[calc(100%-2rem)] sm:max-w-lg">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Are you sure you want to register for "{event.title}"? By confirming, you agree to attend this event.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter className="flex-col sm:flex-row gap-2">
              <AlertDialogCancel className="mt-0">Cancel</AlertDialogCancel>
              <AlertDialogAction onClick={completeRegistration} className="bg-green-600 hover:bg-green-700">
