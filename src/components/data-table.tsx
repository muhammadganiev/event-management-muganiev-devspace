...
export default function DataTable({
  ...
  // Create a new event
  const handleCreateEvent = async (event: Omit<Event, "id" | "created_at">) => {
          ...
          <>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  >
                    ...
                    <span className="hidden xs:inline"></span>Add Event
                  </Button>
                </div>
              </div>
            ...
            {currentEvent && (
              <EventFormDialog
                ...
                onSubmit={(event) => handleUpdateEvent(event as Event)}
                event={currentEvent}
                title="Edit Event"
              />
            )}
